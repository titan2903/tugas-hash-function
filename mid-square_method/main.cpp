...
int midSquareHashFunction(int key, int tableSize)
{
    ...
    return (index + tableSize) % tableSize;  // Ensure index is positive
}
...
{
    cout << "\nRunning test for dataset " << datasetNum << " and table size " << tableSize << ", using Mid-square Method" << endl;
...
int main()
{
    ...
    {
        runHashTest(dataset1, tableSize, midSquareHashFunction, 1);
        runHashTest(dataset2, tableSize, midSquareHashFunction, 2);
        runHashTest(dataset3, tableSize, midSquareHashFunction, 3);
        runHashTestStr(dataset4, tableSize, stringMidSquareHashFunction, 4);
    }
